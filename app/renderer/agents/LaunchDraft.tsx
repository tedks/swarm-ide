...
export function LaunchDraft({ focus, onLaunch, onClose }: { focus: FocusRef; onLaunch: (context: LaunchContext) => void; onClose: () => void }) {
  ...
  return <form className="agent-draft" onKeyDown={(event) => {
    ...
    <p>Disk version only; unsaved edits are not included. This fixture attaches <strong>no file bytes</strong>. Use the separate live launch draft for core-prepared disk context.</p>
