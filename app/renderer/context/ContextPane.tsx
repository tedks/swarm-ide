...
export function ContextPane({ subject, sections, onOpen, onTask, onRefreshTasks, headingRef }: { subject: ContextSubject | null; sections: ContextSection[]; onOpen: (path: string) => void; onTask?: (target: TaskBacklinkTarget) => void; onRefreshTasks?: () => void; headingRef?: Ref<HTMLHeadingElement> }) {
