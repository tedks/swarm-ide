...
try {
  ...
  const env = { ...process.env, NODE_PATH: '', SWARM_CODEX_BIN: '/nonexistent/controlled-fleet-no-provider', SWARM_TRUSTED_PACKAGE: extracted, SWARM_TRUSTED_PROFILE: profile };
