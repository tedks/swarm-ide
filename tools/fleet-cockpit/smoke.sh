...
trusted_artifacts=${SWARM_ARTIFACT_DIR:-$trusted_source/artifacts/fleet-cockpit-proof}
...
exec "$trusted_scripts/../virtual-desktop-run.sh" "$trusted_scripts/scenario.sh" "$trusted_scripts/launch.sh" fleet-cockpit-proof
