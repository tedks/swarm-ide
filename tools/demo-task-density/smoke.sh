...
density_artifacts=${SWARM_ARTIFACT_DIR:-$density_source/artifacts/demo-task-density}
...
export SWARM_DENSITY_EVIDENCE="$SWARM_ARTIFACT_DIR" SWARM_PLANS_CASE=demo
export SWARM_APP_START_TIMEOUT_MS=120000 SWARM_SCENARIO_TIMEOUT_SECONDS=100
exec "$scripts/../virtual-desktop-run.sh" "$scripts/scenario.sh" "$scripts/launch.sh" demo-task-density
