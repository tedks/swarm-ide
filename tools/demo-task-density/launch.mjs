...
const evidence = await realpath(process.env.SWARM_DENSITY_EVIDENCE);
...
try {
  ...
  const environment = { ...process.env, NODE_PATH: "", SWARM_DENSITY_PACKAGE: extracted, SWARM_DENSITY_PROFILE: profile,
    SWARM_DENSITY_EVIDENCE: evidence, SWARM_DENSITY_SCRATCH: scratch };
