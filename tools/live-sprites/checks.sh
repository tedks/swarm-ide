...
pnpm exec vitest run tests/graph-agent-locations.test.ts tests/graph-agent-overlay.test.tsx tests/directory-layers.test.tsx tests/living-design.test.tsx
