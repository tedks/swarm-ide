...
try {
  ...
  for (let i = 0; i < 2; i++) await writeFile(join(scratch, `absent-${i}.jsonl`), JSON.stringify({type:'session_meta',payload:{id:`10000000-0000-4000-8000-00000000000${i+1}`,timestamp:new Date().toISOString()}})+'\n', {mode:0o600});
