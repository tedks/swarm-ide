...
swarm_window_wait_title 'Topology 0:gray'
...
sleep .2
swarm_window_capture "$SWARM_ARTIFACT_DIR/service-unobserved.png"
...
echo 'Actual unobserved Service UI and ordinary source opening captured; no service build or agent turn.'
