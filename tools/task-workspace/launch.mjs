...
const evidence = await realpath(process.env.SWARM_TASK_WORKSPACE_EVIDENCE);
...
try {
  ...
  const environment = { ...process.env, NODE_PATH: "", SWARM_TASK_WORKSPACE_PACKAGE: extracted, SWARM_TASK_WORKSPACE_PROFILE: profile,
    SWARM_TASK_WORKSPACE_EVIDENCE: evidence, SWARM_TASK_WORKSPACE_SCRATCH: scratch };
