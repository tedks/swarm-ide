...
trusted_artifacts=${SWARM_ARTIFACT_DIR:-$trusted_source/artifacts/trusted-local-proof}
...
export SWARM_VIRTUAL_DISPLAY=${SWARM_VIRTUAL_DISPLAY:-:138}
export SWARM_VIRTUAL_DESKTOP_PORT=${SWARM_VIRTUAL_DESKTOP_PORT:-55218}
exec "$trusted_scripts/../virtual-desktop-run.sh" "$trusted_scripts/scenario.sh" "$trusted_scripts/launch.sh" trusted-local-proof
