...
function ok(requestId: string, snapshot: WorkspaceSnapshot, file?: FileResult, agent?: AgentResult, task?: TaskResult, repo?: RepositoryResult, search?: RepositorySearchResult, external?: ExternalResult): CoreResponse {
