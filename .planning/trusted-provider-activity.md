...
ROOT normal-merged original PR71 at50ca30b while the contract check was underway. Follow-up PR77 therefore owns the unmerged compatibility correction7b2796c and exact committed F1 dependency. Focused21PASS in2.282s and native delta CLEAN; Ditz trusted-activity-contract-bound-20260907 tracks this follow-up. Original provider activity is already landed, but the100-row alignment is not yet adopted. No moving runtime/store was consumed; no additional provider turn occurred.
