...
| Context: `contextual-information` | PR41 implements the [first truthful Context slice](contextual-information.md): exact source/buffer facts, independent service/capture evidence, explicit task/graph/directory attention and honest unavailable providers. PR42 adds deliberate service/interface-to-declaration navigation and actual retained-service core-recovery proof, not inferred callsites or external implementations. The broad issue remains open: reverse knowledge/task links, live build links and cursor-level metrics need their own providers. |
