...
| Context: `contextual-information` | PR41 implements the [first truthful Context slice](contextual-information.md): exact source/buffer facts, independent service/capture evidence, explicit task/graph/directory attention and honest unavailable providers, with real packaged proof. The broad issue remains open: reverse knowledge/task links, live build links and cursor-level metrics need their own providers. |
