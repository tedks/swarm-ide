...
| Context: `contextual-information` | Selecting two unrelated files shows their own known facts/links and honest unavailable instruments, not FraudCheck widgets for both. The [Q0 contract](contextual-information.md) specifies one next implementation; design is not delivery. Follow navigation/search; later cursor-level metrics require symbol/runtime evidence. |
